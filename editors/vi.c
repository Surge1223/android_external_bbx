...
//config:	depends on VI
//config:	help
//config:	  Selecting this option will make bbx vi signal aware. This will
//config:	  make bbx vi support SIGWINCH to deal with Window Changes, catch
...
//config:	depends on VI
//config:	help
//config:	  Make bbx vi remember the last command and be able to repeat it.
//config:
...
//config:	depends on VI
//config:	help
//config:	  Make bbx vi behave nicely with terminals that get resized.
//config:
...
/* bbx build system provides that, but it's better */
