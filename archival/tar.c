/* vi: set sw=4 ts=4: */
/*
 * Mini tar implementation for bbx
 *
 ...
 *
 * Based in part on the tar implementation from bbx-0.28
...
//config:	depends on TAR || DPKG
//config:	help
//config:	  With this option bbx supports GNU long filenames and
//config:	  linknames.
//config:
...
//config:	depends on TAR
//config:	help
//config:	  With this option bbx supports GNU tar -m
...
//config:	help
//config:	  With this option bbx supports restoring SELinux labels
