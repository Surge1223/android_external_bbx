...
/*
 * Uncompress applet for bbx (c) 2002 Glenn McGrath
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 */
 ...
 *
 * Originally adjusted for bbx by Sven Rudolph <sr1@inf.tu-dresden.de>
 ...
 * bbx functions by Glenn McGrath
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 *
...
/*
 * Modified for bbx by Glenn McGrath
