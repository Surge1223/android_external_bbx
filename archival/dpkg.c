/* vi: set sw=4 ts=4: */
/*
 *  mini dpkg implementation for bbx.
 ...
 *
 *  started life as a bbx implementation of udpkg
 *
 * Licensed under GPLv2 or later, see file LICENSE in this source tree.
 */
/*
 * known difference between bbx dpkg and the official dpkg that i don't
...
/* This code is taken from dpkg and modified slightly to work with bbx */
...
what arguments. I realize that bbx does not support all of
