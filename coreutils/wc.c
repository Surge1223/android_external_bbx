 ...
 * Problems in the previous bbx implementation (besides bloat) included:
 ...
 * NOTES:
 *
 * The previous bbx wc attempted an optimization using stat for the
