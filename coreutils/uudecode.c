...
//usage:       "$ uudecode -o bbx bbx.uu\n"
//usage:       "$ ls -l bbx\n"
//usage:       "-rwxr-xr-x   1 ams      ams        245264 Jun  7 21:35 bbx\n"
...
/* Test script.
Put this into an empty dir with bbx binary, an run.

#!/bin/sh
test -x bbx || { echo "No ./bbx?"; exit; }
ln -sf bbx uudecode
ln -sf bbx uuencode
>A_null
echo -n A >A
