/* vi: set sw=4 ts=4: */
/*
 * Mini dd implementation for bbx
 *
 *
...
static void dd_output_status(int UNUSED_PARAM cur_signal)
{
	...
	/* Corner cases:
	 * ./bbx dd </dev/null >/dev/null
	 * ./bbx dd bs=1M count=2000 </dev/zero >/dev/null
	 * (echo DONE) | ./bbx dd >/dev/null
	 * (sleep 1; echo DONE) | ./bbx dd >/dev/null
	 */
