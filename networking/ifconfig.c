 ...
 *
 * From initial port to bbx, removed most of the redundancy by
...
/* I don't know if this is needed for bbx or not.  Anyone? */
...
#if ENABLE_FEATURE_IPV6 && defined(__NOT_NDK__)
struct in6_ifreq {
