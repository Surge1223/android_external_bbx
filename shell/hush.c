 ...
 *      support has been adapted from bbx-0.49pre's lash, which is
...
#include "bbx.h"  /* for APPLET_IS_NOFORK/NOEXEC */
#include "unicode.h"
...
# endif
 ...
 do_exec:
	...
	execve(bb_bbx_exec_path, argv, pp);
		...
		char **argv_expanded)
{
	...
	/* Check if the command matches any bbx applets */
	{
